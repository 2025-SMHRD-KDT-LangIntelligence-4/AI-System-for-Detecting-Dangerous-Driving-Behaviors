...
<!--=====================================   검색   ======================================== -->   		
   			...
   			<form id="searchForm" action="${pageContext.request.contextPath}/logPage" method="get">
			    <div class="div50">
			        ...
			        <button type="submit" style="background: none; border: none; padding: 0;">
			            <img class="item" src="${pageContext.request.contextPath}/image/search.svg" alt="검색">   				
			        </button>
			    </div>
			</form>
 							...
 							<!-- 위험 등급 : 상 -->
   							...
   							<div class="frame-parent2 iconChange">
								...
								<img class="frame-item checkBox" src="/image/checkBox.svg">
   								...
   								<!-- 위험 등급 중 아이콘 -->
   								<img class="frame-item" src="/image/BlueCircle.svg">    								
   							</div>
 						</div>
   					</div>
				            ...
				            <div class="frame-parent9">
				                ...
				                <div class="pm-wrapper"> 
				                    <div class="b">
				                        ...
				                        <c:choose>
				                            <c:when test="${level == 1}">
				                                <img src="${cpath}/image/BlueCircle.svg" alt="위험등급 1" style="width: 16px; height: 16px;" />
				                            </c:when>
				                            <c:when test="${level == 2}">
				                                <img src="${cpath}/image/YellowCircle.svg" alt="위험등급 2" style="width: 16px; height: 16px;" />
				                            </c:when>
				                            <c:when test="${level == 3}">
				                                <img src="${cpath}/image/RedCircle.svg" alt="위험등급 3" style="width: 16px; height: 16px;" />
				                            </c:when>
				                            <c:otherwise>
				                                <span style="font-size: 10px;">등급 정보 없음</span>
				                            </c:otherwise>
				                        </c:choose>
				                    </div>
				                </div>
				                ...
				                <div class="pm-wrapper">
				                    <div class="b">
				                        <p class="p">${log.actionMethod}</p>
				                        <p class="p">
				                            <span>${log.actionCount}회(</span>
				                            <span class="span">${log.actionStatus}</span>
